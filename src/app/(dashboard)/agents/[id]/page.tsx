...
export default function AgentPage() {
  ...
  const handleGenerate = async () => {
    ...
    const mockOutput = `# Generated Content for "${agent.name}"

## Input Analysis
Based on your inputs, here's what I've created:
...
This is a demonstration of the ${agent.name} agent output. In production, this would be connected to the OpenAI API to generate real, high-quality content based on your inputs.

### Key Points
1. The content is tailored to your **${tone.toLowerCase()}** tone preference
2. The length is optimized for **${length.toLowerCase()}** output
3. All inputs have been analyzed and incorporated

### Sample Output
Here's what the actual output would look like:

> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris.

---
*Generated by Synapse AI - ${agent.name}*`;
